...
namespace PruebaA
{
	...
	{
		MySqlConnection connection = new MySqlConnection("datasource=localhost;database=EditorialPiedra;port = 3306;username=root;password = 1016;Integrated Security = True");
